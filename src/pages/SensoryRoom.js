...
const SensoryRoom = () => {
  ...
  return (
    <div className="w-full relative [background:linear-gradient(0deg,_#a4c9ff,_rgba(190,_216,_255,_0))] h-[1974px] overflow-hidden">
      <img
      ...
      <footer className="absolute w-[calc(100%_-_1px)] right-[1px] bottom-[0px] left-[0px] h-[50px] text-center text-3xl text-black font-montserrat">
        ...
        <div className="absolute w-[calc(100%_-_1215px)] bottom-[0px] left-[608px] flex items-center h-[50px]">
